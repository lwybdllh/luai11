    ...
    ["7f311a19cf252a70a5ee"], {
        OBTHSjw4gT: (t, e, i) => {
            ...
            const h = n().extend({
                ...
                queryParams: ["account_type", "pdf_institution_id", "stmt_suggestion_count", "accountid", "account_name", "document_id", "isAccountInfoNeeded", "tax_type", "table_name"],
                account_type: "",
                pdf_institution_id: "",
                document_id: null,
                ...
                xmlNotes: ["zb.import.xml.notes1", "zb.import.xml.notes2", "zb.import.xml.notes3"],
                xRechnungNotes: ["zb.import.de.note1", "zb.import.de.note2", "zb.import.de.note3", "zb.import.de.note4", "zb.import.de.note5", "zb.import.de.note6"],
                canShowGSTHelp: (0, s.computed)("model.entity_constant", "appMeta.isSandhaiApp", (function() {
                    return this.currentOrg.isIndiaVersion && !["statement", "custpmt_invoice", "workpaper_trial_balance", "workpaper_balance_sheet", "workpaper_profit_and_loss"].includes(this.model.entity_constant) && !this.get("appMeta.isSandhaiApp")
                })),
                ...
                fileFormatsDesc: (0, s.computed)("model.isBankStatementImport", "isABCImport", (function() {
                    return this.isABCImport ? "zb.import.abc" : this.isItemImagesImport ? "zb.import.item.image.fileformats" : this.get("model.isBankStatementImport") ? "zb.import.bankfileformats" : "zb.import.fileformats"
                })),
                ...
                fileName: (0, s.computed)("model.{sample_file_name,editionSpecificCsvFileNames}", "currentOrg.version", (function() {
                    var t;
                    let {
                        model: e
                    } = this, i = null === (t = l.default.VERSION_DETAILS.findBy("version", this.currentOrg.version)) || void 0 === t ? void 0 : t.versionCode;
                    return e.editionSpecificCsvFileNames && e.editionSpecificCsvFileNames[i] || e.sample_file_name
                })),
                sampleXlsFileName: (0, s.computed)("model.{sample_file_name_xls,editionSpecificXlsFileNames}", (function() {
                    let {
                        model: t
                    } = this, {
                    ...
                    return t.editionSpecificXlsFileNames && t.editionSpecificXlsFileNames[e] || t.sample_file_name_xls
                })),
                ...
                canShowTriggerBankStmtPromotion: (0, s.computed)("features.canShowStmtforwarding", "currentOrg.{is_statement_forwarding_enabled,isSourcePracticeApp}", "model.isBankStatementImport", (function() {
                    let {
                        features: {
                            canShowStmtforwarding: t
                        } = {},
                        currentOrg: {
                            is_statement_forwarding_enabled: e,
                            isSourcePracticeApp: i
                        } = {},
                        model: {
                            isBankStatementImport: o
                        } = {}
                    } = this;
                    return t && o && !(e || i)
                })),
                actions: {
                    ...
                    _importFile() {
                        ...
                        let n = this.getFormData(),
                            ...
                            a = this.isItemImagesImport ? "/images/bulkupload" : "/uploadfile?organization_id=".concat(this.currentOrg.organization_id, "&is_new_flow=").concat(s),
                            r = {
                                type: "POST",
                                data: n,
                                processData: !1,
                        ...
                        return this.isItemImagesImport && !i.isVariant && (r.copy_to_variants = !0), this.set("model.isUploading", !0), i.sendRequest(a, r).then((t => {
                            let {
                                data: e = {}
                            } = t;
                            return this.isItemImagesImport ? (this.notificationService.success(t.message), void this.send("closeWizardAndReDirect")) : (i.deserialize(e), i.is_file_type_pdf && (this.send("showSuccessMsg", e.message), this.send("closeWizardAndReDirect")), this.skipMapping ? (i.set("skipMapping", !0), void this.send("gotoImportPreview", i)) : void this.send("showFieldMapping", i))
                        })).catch((t => {
                    ...
                    handleContactSupport(t) {
                        null == t || t(), this.set("canShowPDFBankpopover", !1), this.send("contactSupport")
                    },
                    removeUploadedFile() {
                        let {
                            isUploadedFromCloud: t
                    ...
                    convertXMLToJSON() {
                        ...
                        let {
                            ...
                            organization_id: e,
                            entity: o
                        }, a = i, r = m.default.constructUrlParam("/einvoice/import", s), d = new FormData;
                        d.append("importfile", n), this.set("isXMLImportLoading", !0), this.store.ajax(r, {
                            ...
                            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                ...
                                n = {
                                    bill: "bills.new",
                                    vendor_credit: "vendorcredits.new"
                                }[s.entity];
